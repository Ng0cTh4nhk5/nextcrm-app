...
export const NewTaskFromCRMToWatchersEmail = ({
  ...
  const previewText =
    userLanguage === "vi"
      ? `Công việc mới từ hệ thống CBEC`
      : userLanguage === "en"
      ? `New task from CBEC app`
      : `Nový úkolu z aplikace CBEC`;
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="border border-solid border-[#eaeaea] rounded my-[40px] mx-auto p-[20px] w-[465px]">
            <Heading className="text-black text-2xl font-normal text-center p-0 my-[30px] mx-0">
              {userLanguage === "vi"
                ? "Có công việc mới trong Công ty mà bạn đang theo dõi"
                : userLanguage === "en"
            ...
            <Text className="text-black text-sm leading-[24px]">
              ...
              {userLanguage === "vi"
                ? ` đã tạo một công việc và chúng tôi thông báo cho bạn vì bạn là người theo dõi Công ty này. `
                : userLanguage === "en"
